                ...
                <div class="contact-box">
                    ...
                    <div class="contact-form-container">
                        ...
                        <form class="contact-form" id="contact-form">
                            ...
                            <div class="form-group">
                                <textarea id="bericht" placeholder="Bericht" rows="5"></textarea>
                            </div>
            ...
            <div class="right-column">
                <div class="info-section">
                    <div class="service-info">
                        ...
                        <p>
                            Neem gemakkelijk contact op via een van onze contactopties en
                            wij helpen je graag met al je vragen. De openingstijden van onze
                            klantenservice zijn:
                        </p>
                        <p class="opening-hours">
                            <strong>Maandag t/m Vrijdag: 08:00 – 17:00</strong>
                        </p>
                    </div>
                    ...
                    <div class="follow-us">
                        ...
                        <div class="social-icons">
                            <a href="https://www.facebook.com/BOUW3D" class="social-link" target="_blank">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="https://www.instagram.com/BOUW3D" class="social-link" target="_blank">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="https://www.linkedin.com/company/BOUW3D" class="social-link" target="_blank">
