...
<body>
  ...
  <main class="page">
    ...
    <aside class="scene" aria-label="3D-printer werkplaats">
      <!-- Achtergrond = JOUW BESTAND -->
      <div class="scene-bg" role="img" aria-label="Industriële 3D-printer in werkplaats"></div>

      <div class="scene-vignette"></div>
      <div class="worklight"></div>
      <div class="screen-glow"></div>
      <div class="printhead"><div class="nozzle"></div><div class="head-led"></div></div>
      <div class="print-part"></div>
      <div class="steam steam-1"></div><div class="steam steam-2"></div><div class="steam steam-3"></div>
      <canvas id="sparks" class="sparks" aria-hidden="true"></canvas>
    </aside>
  </main>
