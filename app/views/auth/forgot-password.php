...
<html lang="<?= htmlspecialchars($_SESSION['lang'] ?? 'nl') ?>">
  <head>
    ...
    <title><?= htmlspecialchars(translate('title_forgot', $formHandlingTranslations, $lang)) ?> – Bouw3D</title>
    ...
    <main>
      <div class="forgot-password-card">
        ...
        <h1 class="accent-color">
          <?= htmlspecialchars(translate('title_forgot', $formHandlingTranslations, $lang)) ?>
        </h1>
