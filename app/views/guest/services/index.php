    ...
    <main>
        ...
        <div class="layout-row">
            ...
            <section>
                ...
                <ul>
                    ...
                    <li>Hulpmiddelen en mallen</li>
                </ul>
                <p>Onze materialen:</p>
                <p>Ons portfolio omvat een breed scala aan kunststoffen, waaronder nylon (PA) voor hoge sterkte en flexibiliteit, ABS voor robuuste onderdelen, en specialistische polymeren die voldoen aan specifieke milieu- of brandveiligheidseisen.</p>
            </section>
        </div>
        ...
        <div class="layout-row">
            <section>
                ...
                <p>3D-printing vereist een andere benadering van ontwerp dan traditionele productie. Onze ontwerpservice overbrugt de kloof tussen uw bouwkundige idee en een print-ready bestand, waardoor we de faalkans minimaliseren en de efficiëntie maximaliseren.</p>
