  ...
  <body>
    ...
    <main>
        ...
        <div class="example-list">
          ...
          <div class="content fs-2">
            <article id="example-1" class="content-item">
              ...
              <figure>
                <img src="/assets/images/index-images/Klant-1.png" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
            ...
            <article id="example-2" class="content-item">
              ...
              <figure>
                <img src="/assets/images/index-images/klant-2.jpg" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
            ...
            <article id="example-3" class="content-item">
              ...
              <figure>
                <img src="/assets/images/index-images/klant-3.png" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
            ...
            <article id="example-4" class="content-item">
              ...
              <figure>
                <img src="/assets/images/index-images/klant-4.jpg" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
            ...
            <article id="example-5" class="content-item">
              ...
              <figure>
                <img src="/assets/images/index-images/klant-5.jpg" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
      ...
      <section class="awards p-2">
        ...
        <article class="award">
          <img src="/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText1', $translations, $lang) ?>" />
          <div>
        ...
        <article class="award">
          <img src="/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText2', $translations, $lang) ?>" />
          <div>
        ...
        <article class="award">
          <img src="/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText3', $translations, $lang) ?>" />
          <div>
        ...
        <article class="award">
          <img src="/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText4', $translations, $lang) ?>" />
          <div>
