    ...
    <main>
      <section class="hero">
        <div class="hero-content">
          ...
          <a href="/about-us" class="button button--large"><?= translate('discover', $translations, $lang) ?></a>
        </div>
        ...
        <div class="example-list">
          ...
          <div class="content fs-2">
            <article id="example-1" class="content-item">
              <blockquote><?= translate('clientText1', $translations, $lang) ?></blockquote>
              <figure>
                <img src="<?= BASE_URL ?>/assets/images/index-images/Klant-1.png" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
                <figcaption><?= translate('clientName1', $translations, $lang) ?></figcaption>
              </figure>
            </article>
            <article id="example-2" class="content-item">
              <blockquote><?= translate('clientText2', $translations, $lang) ?></blockquote>
              <figure>
                <img src="<?= BASE_URL ?>/assets/images/index-images/klant-2.jpg" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
                <figcaption><?= translate('clientName2', $translations, $lang) ?></figcaption>
              </figure>
            </article>
            <article id="example-3" class="content-item">
              <blockquote><?= translate('clientText3', $translations, $lang) ?></blockquote>
              <figure>
                <img src="<?= BASE_URL ?>/assets/images/index-images/klant-3.png" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
                <figcaption><?= translate('clientName3', $translations, $lang) ?></figcaption>
              </figure>
            </article>
            <article id="example-4" class="content-item">
              <blockquote><?= translate('clientText4', $translations, $lang) ?></blockquote>
              <figure>
                <img src="<?= BASE_URL ?>/assets/images/index-images/klant-4.jpg" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
                <figcaption><?= translate('clientName4', $translations, $lang) ?></figcaption>
              </figure>
            </article>
            <article id="example-5" class="content-item">
              <blockquote><?= translate('clientText5', $translations, $lang) ?></blockquote>
              <figure>
                <img src="<?= BASE_URL ?>/assets/images/index-images/klant-5.jpg" alt="<?= translate('clientAlt', $translations, $lang) ?>" />
      ...
      <section class="awards p-2">
        ...
        <article class="award">
          <img src="<?= BASE_URL ?>/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText1', $translations, $lang) ?>" />
          <div>
            <h3><?= translate('awardsSubTitle1', $translations, $lang) ?></h3>
            <p><?= translate('awardsText1', $translations, $lang) ?></p>
          </div>
        </article>
        <article class="award">
          <img src="<?= BASE_URL ?>/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText2', $translations, $lang) ?>" />
          <div>
            <h3><?= translate('awardsSubTitle2', $translations, $lang) ?></h3>
            <p><?= translate('awardsText2', $translations, $lang) ?></p>
          </div>
        </article>
        <article class="award">
          <img src="<?= BASE_URL ?>/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText3', $translations, $lang) ?>" />
          <div>
            <h3><?= translate('awardsSubTitle3', $translations, $lang) ?></h3>
            <p><?= translate('awardsText3', $translations, $lang) ?></p>
          </div>
        </article>
        <article class="award">
          <img src="<?= BASE_URL ?>/assets/images/index-images/placeholder-image.webp" alt="<?= translate('altText4', $translations, $lang) ?>" />
          <div>
            <h3><?= translate('awardsSubTitle4', $translations, $lang) ?></h3>
            <p><?= translate('awardsText4', $translations, $lang) ?></p>
          </div>
        </article>
      </section>
    </main>
